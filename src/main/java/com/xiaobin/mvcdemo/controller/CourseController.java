...
import com.xiaobin.mvcdemo.view.CourseService;
...
public class CourseController {
    ...
    @RequestMapping(value = "view", method= RequestMethod.GET)//方法级别的URL
...
//    @RequestMapping(value = "view2/{courseId}", method= RequestMethod.GET)//方法级别的URL
